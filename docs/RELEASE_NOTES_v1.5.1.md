...
Every tracked v1.5.1 issue is closed, its code is merged to `main`, and every live-play fix in this release
(#79, #105, #107, #114) has been confirmed on real two-Mac hardware, build `v151-test6 496999e`.
...
- A guest's key-down mine no longer detonates under its own tank when the drop lands on the tile it already occupies (#105, PR #121, live-confirmed 2026-09-22 driving and continuously laying mines as the guest).
- Shells no longer vanish for their whole flight at roughly 10 of 16 firing headings (#114, PR #123, live-confirmed 2026-09-22 firing stationary, moving, rotating in place, and moving+firing) — the sprite sheet only had directional art for 6 of the 16 headings `headingColumn` can produce; the other 10 rendered a transparent cell for the shot's entire flight.
