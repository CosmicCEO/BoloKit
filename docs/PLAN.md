...
| Wave 6.1 | Tick orchestrator — `runclient()`/`runserver()`; new pause/timelimit/domination-basecontrol state machines | 🟨 D35 fix committed (`1e0cbe6`+`91c4a8d`), 363 tests (+2) — awaiting PARITY re-audit before close |
