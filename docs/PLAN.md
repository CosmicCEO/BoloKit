...
| Wave 6.1 | Tick orchestrator — `runclient()`/`runserver()`; new pause/timelimit/domination-basecontrol state machines | 🟩 Coding GO issued 2026-09-02 — pre-brief reviewed, no blocking findings (see `docs/AGENT_NOTES.md`) |
