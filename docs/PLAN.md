...
| Wave 6.1 | Tick orchestrator — `runclient()`/`runserver()`; new pause/timelimit/domination-basecontrol state machines | 🟨 Code complete, `d0a9834`+`b028bf8` — awaiting PARITY audit before close (361 tests, +16) |
