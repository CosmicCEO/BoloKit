...
**Next step:** confirm #105 on the two-Mac build above, then merge `9a58453`. After that, fix the four still-open v1.5.1 issues (fog/vision — #77, #79; session lifecycle — #107; shells — #114). #113 and #89 stay in v1.5.2. Run `swift test` against `main` before the `v1.5.1` tag, then update this file's "Shipped" section.
