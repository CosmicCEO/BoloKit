...
**Current tagged drop:** `v1.6.5`. [GitHub release](https://github.com/CosmicCEO/BoloKit/releases/tag/v1.6.5), merged via [PR #151](https://github.com/CosmicCEO/BoloKit/pull/151) 2026-09-24. Bundles the visual-polish milestone (`v1.6.1`, #137/#140/#110) and the full four-theme parity arc (man/tank/boat/sound, milestones 23-26) plus #139's host-engine crash fix -- none of the four themes were tagged individually as they landed, so all ship together under the last theme's number. Release notes: `docs/RELEASE_NOTES_v1.6.5.md`. **`v1.6.0`–`v1.2.0`, `v1.1.0`, and `v1.0.0` shipped.** `v1.6.0`: milestone [4](https://github.com/CosmicCEO/BoloKit/milestone/4) closed 2026-09-23, #25 closed, code merged to `main` (PRs [#128](https://github.com/CosmicCEO/BoloKit/pull/128), [#141](https://github.com/CosmicCEO/BoloKit/pull/141)), Metal renderer plus the guest desync fixes it surfaced both live-confirmed on real two-Mac hardware. Release notes: `docs/RELEASE_NOTES_v1.6.0.md`.
