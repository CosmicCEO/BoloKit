...
`v1.2.1` (build 8). Playable host-and-join. 782 SwiftPM tests (562 BoloKitTests + 220 DifferentialTests) plus 66 `Bolo 2026Tests`. One pre-existing flaky timing test exists; do not treat a single isolated flake of that class as a new regression.
