...
A Swift port of [XBolo](https://github.com/bananazon/xbolo), a Cocoa clone of Stuart
Cheshire's classic multiplayer tank game *Bolo*. This project exists to learn Xcode,
Swift, on-device AI (FoundationModels), and multiplayer networking, and to end up with
a Bolo you can play natively on modern macOS.
...
Early scaffolding. See `docs/` and the project plan for the current phase.
...
- `Sources/BoloCore` is the target: a pure Swift simulation with no AppKit dependency,
